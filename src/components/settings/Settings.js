...
import { cleartItem, showRatingApp } from '../../utilities/globalFunction'
...
class Settings extends Component {
  ...
  handleEmail = async () => {
    ...
    email(to, {
      subject: 'Feedback Movie 24h Trending App',
    ...
    return (
      <View>
        <ScrollView style={{marginTop: 20,minHeight: 400}}>
          ...
          <TouchableOpacity style={{ backgroundColor: '#D9D9D9', padding: 3, marginTop :6}}>
            <Text style={[style.text, style.headingText]} onPress={this.ratingApp}>
             Rating App
            </Text>
          </TouchableOpacity>
